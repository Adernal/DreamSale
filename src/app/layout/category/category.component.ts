...
export class CategoryComponent implements OnInit {
  ...
  addCategory(){
    ...
    this.Display_Order= this.categoryForm.value.Display_Order;
    this.category.push({
  "Id": this.Id,
  "CustomProperties": {
    "sample string 1": {},
  ...
  editCategoryMode(id : HTMLFormElement){
    ...
    // console.log(this.category[1].Name);
     ...
     this.Display_Order = this.category[+this.Id].Display_Order;
  ...
  editCategory(){
    ...
    this.category[+this.Id].Display_Order = this.Display_Order;
