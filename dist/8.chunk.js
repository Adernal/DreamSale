...
/***/ "../../../../../src/app/layout/customers/customers-routing.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__customers_component__ = __webpack_require__("../../../../../src/app/layout/customers/customers.component.ts");
...
/***/ "../../../../../src/app/layout/customers/customers.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__customers_service__ = __webpack_require__("../../../../../src/app/layout/customers/customers.service.ts");
...
var CustomersComponent = (function () {
    function CustomersComponent(http, customersService) {
        this.http = http;
    ...
    CustomersComponent.prototype.getCustomers = function (page) {
        var _this = this;
        this.loadingCustomer = true;
        this.customersService.getCustomers(page)
            .subscribe(function (response) {
            _this.currentPageNumber = page;
            _this.customerList = (response.json().Data);
    ...
    CustomersComponent.prototype.deleteCustomer = function (id) {
        ...
        if (confirmation) {
            ...
            this.customersService.deleteCustomers(+id.name)
                ...
                alert('Deleted !');
                _this.getCustomers(_this.currentPageNumber);
            }, function (error) {
                console.log(error);
                alert('Can\'t fetch data ! Please refresh or check your connnection !');
            });
    ...
    CustomersComponent.prototype.getCurrentCustomer = function (id) {
        return [];
    };
    CustomersComponent.prototype.searchCustomer = function () {
        var _this = this;
        this.loadingCustomer = true;
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])('c'),
...
], CustomersComponent.prototype, "customerForm", void 0);
CustomersComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'app-customers',
        template: __webpack_require__("../../../../../src/app/layout/customers/customers.component.html"),
        styles: [__webpack_require__("../../../../../src/app/layout/customers/customers.component.scss")]
    })
    /* This is still in development ! Has bugs ! */
    ,
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__angular_http__["b" /* Http */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__customers_service__["a" /* CustomersService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__customers_service__["a" /* CustomersService */]) === "function" && _c || Object])
], CustomersComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__customers_routing_module__ = __webpack_require__("../../../../../src/app/layout/customers/customers-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__customers_component__ = __webpack_require__("../../../../../src/app/layout/customers/customers.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared__ = __webpack_require__("../../../../../src/app/shared/index.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__angular_forms__ = __webpack_require__("../../../forms/@angular/forms.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__filter_pipe__ = __webpack_require__("../../../../../src/app/layout/customers/filter.pipe.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__customers_service__ = __webpack_require__("../../../../../src/app/layout/customers/customers.service.ts");
...
CustomersModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_2__customers_routing_module__["a" /* CustomersRoutingModule */],
            __WEBPACK_IMPORTED_MODULE_4__shared__["b" /* PageHeaderModule */],
            __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormsModule */],
            __WEBPACK_IMPORTED_MODULE_7_ngx_pagination__["a" /* NgxPaginationModule */],
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_8__customers_service__["a" /* CustomersService */]],
        declarations: [__WEBPACK_IMPORTED_MODULE_3__customers_component__["a" /* CustomersComponent */], __WEBPACK_IMPORTED_MODULE_6__filter_pipe__["a" /* FilterPipe */]]
    })
], CustomersModule);
...
/***/ "../../../../../src/app/layout/customers/customers.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var CustomersService = (function () {
    ...
    CustomersService.prototype.getCustomers = function (page) {
    ...
    CustomersService.prototype.updateCustomers = function (customers, id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Headers */]({ 'Content-Type': 'application/json' });
    ...
    CustomersService.prototype.deleteCustomers = function (id) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Headers */]({ 'Content-Type': 'application/json' });
        return this.http.post('http://piyushdaftary-001-site1.ctempurl.com/api/Customers/DeleteCustomer?id=' + id, null, { headers: headers });
    };
    CustomersService.prototype.searchCustomers = function (searchParameters) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["c" /* Headers */]({ 'Content-Type': 'application/json' });
...
/***/ "../../../../../src/app/layout/customers/filter.pipe.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
