...
namespace DreamSale.Infrastructure.DependencyManagement
{
    ...
    public class ContainerManager
    {
        ...
        public virtual object ResolveUnregistered(Type type, ILifetimeScope scope = null)
        {
            ...
            foreach (var constructor in constructors)
            {
                try
                {
                    ...
                    foreach (var parameter in parameters)
                    {
                        ...
                        if (service == null) throw new DreamSaleException("Unknown dependency");
            ...
            throw new DreamSaleException("No constructor  was found that had all the dependencies satisfied.");
        }
