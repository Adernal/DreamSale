...
namespace Denmakers.DreamSale.Services.Localization
{
    public static class LocalizationExtensions
    {
        ...
        public static string GetLocalized<T>(this T entity, 
            Expression<Func<T, string>> keySelector, IWorkContext workContext, ILanguageService languageService, ILocalizedEntityService localizedEntityService
            )
            where T : BaseEntity, ILocalizedEntity
        {
            return GetLocalized(entity, keySelector, workContext.WorkingLanguage.Id, languageService, localizedEntityService);
        }
        /// <summary>
        /// Get localized property of an entity
        /// </summary>
        ...
        public static string GetLocalized<T>(this T entity,
            ...
            where T : BaseEntity, ILocalizedEntity
        {
            return GetLocalized<T, string>(entity, keySelector, languageId, languageService, localizedEntityService, returnDefaultValue, ensureTwoPublishedLanguages);
        }
        /// <summary>
        /// Get localized property of an entity
        /// </summary>
