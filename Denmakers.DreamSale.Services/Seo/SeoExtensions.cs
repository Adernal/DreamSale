...
namespace Denmakers.DreamSale.Services.Seo
{
    public static class SeoExtensions
    {
        ...
        public static string GetSeName(this ProductTag productTag, int languageId)
        {
            ...
            string seName = GetSeName(productTag.Name/*.GetLocalized(x => x.Name, languageId)*/);
            return seName;
        }
        ...
        /// <param name="ensureTwoPublishedLanguages">A value indicating whether to ensure that we have at least two published languages; otherwise, load only default value</param>
        /// <returns>Search engine  name (slug)</returns>
        public static string GetSeName(int entityId, string entityName, int languageId, bool returnDefaultValue = true, bool ensureTwoPublishedLanguages = true)
        {
        ...
        */
        ...
        public static string ValidateSeName<T>(this T entity, string seName, string name, bool ensureNotEmpty, IUrlRecordService urlRecordService, SeoSettings seoSettings)
             where T : BaseEntity, ISlugSupported
        {
            if (entity == null)
                throw new ArgumentNullException("entity");

            return ValidateSeName(entity.Id, typeof(T).Name, seName, name, ensureNotEmpty, urlRecordService, seoSettings);
        }
        ...
        /// <param name="ensureNotEmpty">Ensure that sename is not empty</param>
        /// <returns>Valid sename</returns>
        public static string ValidateSeName(int entityId, string entityName, string seName, string name, bool ensureNotEmpty, IUrlRecordService urlRecordService, SeoSettings seoSettings)
        {
        ...
        public static string GetSeName(string name)
        {
            ...
            return GetSeName(name, false/*seoSettings.ConvertNonWesternChars*/, true /*seoSettings.AllowUnicodeCharsInUrls*/);
        }
