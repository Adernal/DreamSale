    ...
    public partial class WorkflowMessageService : IWorkflowMessageService
    {
        ...
        */
            ...
            string fromEmail = null, string fromName = null, string subject = null)
        {
            ...
            //retrieve localized message template data
            var bcc = messageTemplate.GetLocalized(mt => mt.BccEmailAddresses, languageId, _languageService, _localizedEntityService);
            if (String.IsNullOrEmpty(subject))
                subject = messageTemplate.GetLocalized(mt => mt.Subject, languageId, _languageService, _localizedEntityService);
            var body = messageTemplate.GetLocalized(mt => mt.Body, languageId, _languageService, _localizedEntityService);
