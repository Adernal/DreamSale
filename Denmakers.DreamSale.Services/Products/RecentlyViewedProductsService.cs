...
namespace Denmakers.DreamSale.Services.Products
{
    public partial class RecentlyViewedProductsService : IRecentlyViewedProductsService
    {
        ...
        #region Ctor
        public RecentlyViewedProductsService(HttpContextBase httpContext, IProductService productService, ISettingService settingService)
        {
        ...
        protected IList<int> GetRecentlyViewedProductsIds(int number)
        {
            ...
            var recentlyViewedCookie = _httpContext.Request.Cookies.Get("DreamSale.RecentlyViewedProducts");
        ...
        public virtual void AddProductToRecentlyViewedList(int productId)
        {
            ...
            if (recentlyViewedCookie == null)
            {
                recentlyViewedCookie = new HttpCookie("DreamSale.RecentlyViewedProducts");
