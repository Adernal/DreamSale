...
namespace Denmakers.DreamSale.Services.Products
{
    public partial class CompareProductsService : ICompareProductsService
    {
        ...
        /// </summary>
        private const string COMPARE_PRODUCTS_COOKIE_NAME = "dreamSale.CompareProducts";
        ...
        #region Ctor
        public CompareProductsService(HttpContextBase httpContext, IProductService productService, ISettingService settingService)
        {
