...
namespace Denmakers.DreamSale.Services.Affiliates
{
    public static class AffiliateExtensions
    {
        ...
        public static string ValidateFriendlyUrlName(this Affiliate affiliate, string friendlyUrlName, IAffiliateService affiliateService)
        {
            if (affiliate == null)
                throw new ArgumentNullException("affiliate");
