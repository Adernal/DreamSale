...
namespace Denmakers.DreamSale.Services.Media
{
    public partial class PictureService : IPictureService
    {
        ...
        private const int SUPPORTED_LENGTH_OF_BINARY_HASH = 8000;
        #endregion
        ...
        {
            if (SUPPORTED_LENGTH_OF_BINARY_HASH == 0 || !picturesIds.Any())
            ...
            return _dbContext.SqlQuery<HashItem>(String.Format(strCommand, SUPPORTED_LENGTH_OF_BINARY_HASH, picturesIds.Select(p => p.ToString()).Aggregate((all, current) => all + ", " + current))).Distinct()
