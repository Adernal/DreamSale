...
namespace Denmakers.DreamSale.Services.Orders
{
    public partial class OrderProcessingService : IOrderProcessingService
    {
        ...
        //        throw new DreamSaleException("Anonymous checkout is not allowed");

        //    //customer currency
        //    var currencyTmp = _currencyService.GetCurrencyById(
        //        details.Customer.GetAttribute<int>(SystemCustomerAttributeNames.CurrencyId, _genericAttributeService, processPaymentRequest.StoreId));
        ...
        //        details.Customer.GetAttribute<int>(SystemCustomerAttributeNames.LanguageId, _genericAttributeService, processPaymentRequest.StoreId));
        //    if (details.CustomerLanguage == null || !details.CustomerLanguage.Published)
        //        details.CustomerLanguage = _workContext.WorkingLanguage;

        //    //billing address
        //    if (details.Customer.BillingAddress == null)
        //        throw new DreamSaleException("Billing address is not provided");

        //    if (!CommonHelper.IsValidEmail(details.Customer.BillingAddress.Email))
        //        throw new DreamSaleException("Email is not valid");
        ...
        //        throw new DreamSaleException(string.Format("Country '{0}' is not allowed for billing", details.BillingAddress.Country.Name));

        //    //checkout attributes
        //    details.CheckoutAttributesXml = details.Customer.GetAttribute<string>(SystemCustomerAttributeNames.CheckoutAttributes, _genericAttributeService, processPaymentRequest.StoreId);
        ...
        //        .LimitPerStore(processPaymentRequest.StoreId, _shoppingCartSettings).ToList();

        //    if (!details.Cart.Any())
        //        throw new DreamSaleException("Cart is empty");

        //    //validate the entire shopping cart
        //    var warnings = _shoppingCartService.GetShoppingCartWarnings(details.Cart, details.CheckoutAttributesXml, true);
        //    if (warnings.Any())
        //        throw new DreamSaleException(warnings.Aggregate(string.Empty, (current, next) => string.Format("{0}{1};", current, next)));
        ...
        //        if (sciWarnings.Any())
        //            throw new DreamSaleException(sciWarnings.Aggregate(string.Empty, (current, next) => string.Format("{0}{1};", current, next)));
        //    }
        ...
        //        throw new DreamSaleException(string.Format(_localizationService.GetResource("Checkout.MinOrderSubtotalAmount"),
        ...
        //        throw new DreamSaleException(string.Format(_localizationService.GetResource("Checkout.MinOrderTotalAmount"),
        //            _priceFormatter.FormatPrice(minOrderTotalAmount, true, false)));
        //    }

        //    //tax display type
        //    if (_taxSettings.AllowCustomersToSelectTaxDisplayType)
        //        details.CustomerTaxDisplayType = (TaxDisplayType)details.Customer.GetAttribute<int>(SystemCustomerAttributeNames.TaxDisplayTypeId, _genericAttributeService, processPaymentRequest.StoreId);
        //    else
        ...
        //    {
        //        var pickupPoint = details.Customer.GetAttribute<PickupPoint>(SystemCustomerAttributeNames.SelectedPickupPoint, _genericAttributeService, processPaymentRequest.StoreId);
        ...
        //                throw new DreamSaleException("Shipping address is not provided");
        ...
        //                throw new DreamSaleException(string.Format("Country '{0}' is not allowed for shipping", details.ShippingAddress.Country.Name));
        //        }

        //        var shippingOption = details.Customer.GetAttribute<ShippingOption>(SystemCustomerAttributeNames.SelectedShippingOption, _genericAttributeService, processPaymentRequest.StoreId);
        ...
        //        throw new DreamSaleException("Shipping total couldn't be calculated");
        ...
        //    //VAT number
        //    var customerVatStatus = (VatNumberStatus)details.Customer.GetAttribute<int>(SystemCustomerAttributeNames.VatNumberStatusId, _genericAttributeService);
        //    if (_taxSettings.EuVatEnabled && customerVatStatus == VatNumberStatus.Valid)
        //        details.VatNumber = details.Customer.GetAttribute<string>(SystemCustomerAttributeNames.VatNumber, _genericAttributeService);
        ...
        //        throw new DreamSaleException("Order total couldn't be calculated");
        ...
        //            throw new DreamSaleException(recurringCyclesError);
        ...
        //        throw new DreamSaleException("Billing address is not available");
        ...
        //                throw new DreamSaleException("Shipping address is not available");
        ...
        public virtual bool CanVoid(Order order)
        {
            ...
            if (order.PaymentStatus == PaymentStatus.Authorized /*&& _paymentService.SupportVoid(order.PaymentMethodSystemName)*/)
                return true;
        ...
        //#region Methods need to implemented later
        ...
        //                throw new DreamSaleException("Payment method is not active");
        ...
        //                        throw new DreamSaleException("Recurring payments are not supported by selected payment method");
        //                    case RecurringPaymentType.Manual:
        //                    case RecurringPaymentType.Automatic:
        //                        processPaymentResult = _paymentService.ProcessRecurringPayment(processPaymentRequest);
        //                        break;
        //                    default:
        //                        throw new DreamSaleException("Not supported recurring payment type");
        //                }
        //            }
        //            else
        //                //standard cart
        ...
        //            throw new DreamSaleException("processPaymentResult is not available");
        ...
        //            throw new DreamSaleException("Recurring payment is not active");

        //        var initialOrder = recurringPayment.InitialOrder;
        //        if (initialOrder == null)
        //            throw new DreamSaleException("Initial order could not be loaded");

        //        var customer = initialOrder.Customer;
        //        if (customer == null)
        //            throw new DreamSaleException("Customer could not be loaded");

        //        var nextPaymentDate = recurringPayment.NextPaymentDate;
        //        if (!nextPaymentDate.HasValue)
        //            throw new DreamSaleException("Next payment date could not be calculated");
        ...
        //        throw new DreamSaleException("Cannot do cancel for order.");
        ...
        //    if (!CanCapture(order))
        //        throw new DreamSaleException("Cannot do capture for order.");
        ...
        //        throw new DreamSaleException("You can't mark this order as paid");
        ...
        //    if (!CanRefund(order))
        //        throw new DreamSaleException("Cannot do refund for order.");
        ...
        //        throw new DreamSaleException("You can't refund this order");
        ...
        //        throw new DreamSaleException("Cannot do partial refund for order.");
        ...
        //        throw new DreamSaleException("You can't partially refund (offline) this order");
        ...
        //    if (!CanVoid(order))
        //        throw new DreamSaleException("Cannot do void for order.");
        ...
        //        throw new DreamSaleException("You can't void this order");
