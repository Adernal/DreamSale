...
namespace Denmakers.DreamSale.Services.Orders
{
    public partial class RewardPointService : IRewardPointService
    {
        ...
        #region Ctor
        public RewardPointService(IRepository<RewardPointsHistory> rphRepository, IStoreContext storeContext, ISettingService settingService, IBaseService baseService)
        {
