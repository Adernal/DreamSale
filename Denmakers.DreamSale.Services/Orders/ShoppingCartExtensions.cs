...
namespace Denmakers.DreamSale.Services.Orders
{
    public static class ShoppingCartExtensions
    {
        ...
        public static IEnumerable<ShoppingCartItem> LimitPerStore(this IEnumerable<ShoppingCartItem> cart, int storeId, ShoppingCartSettings shoppingCartSettings)
        {
            ...
            out int cycleLength, out RecurringProductCyclePeriod cyclePeriod, out int totalCycles)
        {
            ...
            foreach (var sci in shoppingCart)
            {
                ...
                if (product == null)
                {
                    throw new DreamSaleException(string.Format("Product (Id={0}) cannot be loaded", sci.ProductId));
                }
