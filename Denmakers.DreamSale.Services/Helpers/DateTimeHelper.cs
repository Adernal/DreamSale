...
namespace Denmakers.DreamSale.Services.Helpers
{
    public partial class DateTimeHelper : IDateTimeHelper
    {
        ...
        /// <summary>
        public DateTimeHelper(IWorkContext workContext, IGenericAttributeService genericAttributeService, ISettingService settingService)
        {
            this._workContext = workContext;
            this._genericAttributeService = genericAttributeService;
            this._settingService = settingService;
            this._dateTimeSettings = _settingService.LoadSetting<DateTimeSettings>();
        }
