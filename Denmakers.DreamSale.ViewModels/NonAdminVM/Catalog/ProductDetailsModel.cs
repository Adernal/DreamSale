...
namespace Denmakers.DreamSale.ViewModels.NonAdminVM.Catalog
{
    public partial class ProductDetailsModel
    {
        ...
        public partial class GiftCardModel
        {
            ...
            [DisplayName("Products.GiftCard.RecipientName")]
            [AllowHtml]
            public string RecipientName { get; set; }
            [DisplayName("Products.GiftCard.RecipientEmail")]
            [AllowHtml]
            public string RecipientEmail { get; set; }
            [DisplayName("Products.GiftCard.SenderName")]
            [AllowHtml]
            public string SenderName { get; set; }
            [DisplayName("Products.GiftCard.SenderEmail")]
            [AllowHtml]
            public string SenderEmail { get; set; }
            [DisplayName("Products.GiftCard.Message")]
            [AllowHtml]
