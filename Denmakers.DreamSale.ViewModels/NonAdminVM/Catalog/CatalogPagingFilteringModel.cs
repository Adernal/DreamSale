...
namespace Denmakers.DreamSale.ViewModels.NonAdminVM.Catalog
{
    public partial class CatalogPagingFilteringModel : BasePageableModel
    {
        ...
        /// </summary>
        public partial class PriceRangeFilterItem
        {
            /// <summary>
            /// From
            /// </summary>
                ...
                IWebHelper webHelper, IWorkContext workContext)
            {
                ...
                var allFilters = allOptions.Select(sao =>
                    new SpecificationAttributeOptionFilter
                    {
                        ...
                        SpecificationAttributeName = sao.SpecificationAttribute.GetLocalized(x => x.Name, workContext.WorkingLanguage.Id, languageService, localizedEntityService),
                        SpecificationAttributeDisplayOrder = sao.SpecificationAttribute.DisplayOrder,
                        SpecificationAttributeOptionId = sao.Id,
                        SpecificationAttributeOptionName = sao.GetLocalized(x => x.Name, workContext.WorkingLanguage.Id, languageService, localizedEntityService),
