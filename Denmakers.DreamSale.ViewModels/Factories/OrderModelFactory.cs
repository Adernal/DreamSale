...
using Denmakers.DreamSale.ViewModels.NonAdminVM.Orders;
using System;
        ...
        public virtual OrderDetailsModel PrepareOrderDetailsModel(Order order)
        {
            ...
            foreach (var orderItem in orderItems)
            {
                var orderItemModel = new OrderDetailsModel.OrderItemModel
                {
                    ...
                    ProductName = orderItem.Product.GetLocalized(x => x.Name, _workContext, _languageService, _localizedEntityService),
