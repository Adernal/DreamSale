...
namespace Denmakers.DreamSale.ViewModels.Validators
{
    public abstract class BaseValidator<T> : AbstractValidator<T> where T : class
    {
        ...
        protected virtual void SetDatabaseValidationRules<TObject>(IDbContext dbContext, ILocalizationService localizationService, params string[] filterStringPropertyNames)
        {
            SetStringPropertiesMaxLength<TObject>(dbContext, filterStringPropertyNames);
            SetDecimalMaxValue<TObject>(dbContext, localizationService);
        }
        ...
        /// <typeparam name="TObject">Object type</typeparam>
        /// <param name="dbContext">Database context</param>
        protected virtual void SetDecimalMaxValue<TObject>(IDbContext dbContext, ILocalizationService localizationService)
        {
            if (dbContext == null)
                return;
