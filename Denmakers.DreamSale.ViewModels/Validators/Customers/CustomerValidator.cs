...
{
    public partial class CustomerValidator : BaseValidator<CustomerVM>
    {
            ...
            IDbContext dbContext)
        {
            ...
            SetDatabaseValidationRules<Customer>(dbContext, localizationService);
        }

        private bool IsRegisteredCustomerRoleChecked(CustomerVM model, ICustomerService customerService)
        {
