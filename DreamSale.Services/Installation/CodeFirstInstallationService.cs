...
namespace DreamSale.Services.Installation
{
    public partial class CodeFirstInstallationService : IInstallationService
    {
        ...
        protected virtual void InstallCustomersAndUsers(string defaultUserEmail, string defaultUserPassword)
        {
            ...
            //second user
            var secondUserEmail = "steve_gates@DreamSale.com";
            ...
            //third user
            var thirdUserEmail = "arthur_holmes@DreamSale.com";
            ...
            //fourth user
            var fourthUserEmail = "james_pan@DreamSale.com";
            ...
            //fifth user
            var fifthUserEmail = "brenda_lindgren@DreamSale.com";
            ...
            //sixth user
            var sixthUserEmail = "victoria_victoria@DreamSale.com";
        ...
        protected virtual void InstallOrders()
        {
            ...
            var firstOrderItem3 = new OrderItem()
            {
                ...
                PriceExclTax = 25M,
                OriginalProductCost = decimal.Zero,
                AttributeDescription = "From: Steve Gates &lt;steve_gates@DreamSale.com&gt;<br />For: Brenda Lindgren &lt;brenda_lindgren@DreamSale.com&gt;",
                AttributesXml = "<Attributes><GiftCardInfo><RecipientName>Brenda Lindgren</RecipientName><RecipientEmail>brenda_lindgren@DreamSale.com</RecipientEmail><SenderName>Steve Gates</SenderName><SenderEmail>steve_gates@gmail.com</SenderEmail><Message></Message></GiftCardInfo></Attributes>",
                Quantity = 1,
                DiscountAmountInclTax = decimal.Zero,
                DiscountAmountExclTax = decimal.Zero,
                DownloadCount = 0,
            ...
            var firstOrderGiftcard = new GiftCard
            {
                ...
                RecipientEmail = "brenda_lindgren@DreamSale.com",
                SenderName = "Steve Gates",
                SenderEmail = "steve_gates@DreamSale.com",
            ...
            //second order
            var secondCustomer = _customerRepository.Table.First(c => c.Email.Equals("arthur_holmes@DreamSale.com"));
            ...
            //third order
            var thirdCustomer = _customerRepository.Table.First(c => c.Email.Equals("james_pan@DreamSale.com"));
            ...
            //fourth order
            var fourthCustomer = _customerRepository.Table.First(c => c.Email.Equals("brenda_lindgren@DreamSale.com"));
            ...
            //fifth order
            var fifthCustomer = _customerRepository.Table.First(c => c.Email.Equals("victoria_victoria@DreamSale.com"));
        ...
        protected virtual void InstallSettings(bool installSampleData)
        {
            ...
            settingService.SaveSetting(new StoreInformationSettings
            {
                ...
                FacebookLink = "http://www.facebook.com/DreamSale",
                TwitterLink = "https://twitter.com/DreamSale",
                YoutubeLink = "http://www.youtube.com/user/DreamSale",
                GooglePlusLink = "https://plus.google.com/+DreamSale",
                HidePoweredByDreamSale = false
            });
            ...
            var news = new List<NewsItem>
                                {
                                    new NewsItem
                                    {
                                         AllowComments = true,
                                         Language = defaultLanguage,
                                         Title = "About DreamSale",
                                         Short = "It's stable and highly usable. From downloads to documentation, www.DreamSale.com offers a comprehensive base of information, resources, and support to the DreamSale community.",
                                         Full = "<p>For full feature list go to <a href=\"http://www.DreamSale.com\">DreamSale.com</a></p><p>Providing outstanding custom search engine optimization, web development services and e-commerce development solutions to our clients at a fair price in a professional manner.</p>",
                                         Published  = true,
                                         CreatedOnUtc = DateTime.UtcNow,
                                    },
                                    new NewsItem
                                    {
                                         AllowComments = true,
                                         Language = defaultLanguage,
                                         Title = "DreamSale new release!",
                                         Short = "DreamSale includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included! DreamSale is a fully customizable shopping cart",
                                         Full = "<p>DreamSale includes everything you need to begin your e-commerce online store. We have thought of everything and it's all included!</p>",
                                         Published  = true,
                                         CreatedOnUtc = DateTime.UtcNow.AddSeconds(1),
                                    },
                                    new NewsItem
                                    {
                                         ...
                                         Short = "The new DreamSale store is open now! We are very excited to offer our new range of products. We will be constantly adding to our range so please register on our site.",
        ...
        protected virtual void InstallScheduleTasks()
        {
            var tasks = new List<ScheduleTask>
            {
                new ScheduleTask
                {
                    Name = "Send emails",
                    Seconds = 60,
                    Type = "DreamSale.Services.Messages.QueuedMessagesSendTask, DreamSale.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Keep alive",
                    Seconds = 300,
                    Type = "DreamSale.Services.Common.KeepAliveTask, DreamSale.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Delete guests",
                    Seconds = 600,
                    Type = "DreamSale.Services.Customers.DeleteGuestsTask, DreamSale.Services",
                    Enabled = true,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    Name = "Clear cache",
                    Seconds = 600,
                    Type = "DreamSale.Services.Caching.ClearCacheTask, DreamSale.Services",
                    Enabled = false,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "DreamSale.Services.Logging.ClearLogTask, DreamSale.Services",
                    Enabled = false,
                    StopOnError = false,
                },
                new ScheduleTask
                {
                    ...
                    //60 minutes
                    Seconds = 3600,
                    Type = "DreamSale.Services.Directory.UpdateExchangeRateTask, DreamSale.Services",
                    Enabled = true,
                    StopOnError = false,
                },
            };
