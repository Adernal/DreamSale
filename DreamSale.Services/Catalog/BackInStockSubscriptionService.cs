...
namespace DreamSale.Services.Catalog
{
    ...
    public partial class BackInStockSubscriptionService : IBackInStockSubscriptionService
    {
        ...
        /// <param name="pageSize">Page size</param>
        /// <returns>Subscriptions</returns>
        public virtual IPagedList<BackInStockSubscription> GetAllSubscriptionsByProductId(int productId, int storeId = 0, int pageIndex = 0, int pageSize = int.MaxValue)
        {
            var query = _backInStockSubscriptionRepository.Table;
            //product
