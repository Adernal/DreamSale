...
namespace DreamSale.Services.Catalog.Cache
{
    /// <summary>
        ...
        //IConsumer<EntityDeleted<Order>>
    {
        ...
        /// {6} : current store ID
        /// </remarks>
        public const string PRODUCT_PRICE_MODEL_KEY = "DreamSale.totals.productprice-{0}-{1}-{2}-{3}-{4}-{5}-{6}";
        public const string PRODUCT_PRICE_PATTERN_KEY = "DreamSale.totals.productprice";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCT_CATEGORY_IDS_MODEL_KEY = "DreamSale.totals.product.categoryids-{0}-{1}-{2}";
        public const string PRODUCT_CATEGORY_IDS_PATTERN_KEY = "DreamSale.totals.product.categoryids";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string PRODUCT_MANUFACTURER_IDS_MODEL_KEY = "DreamSale.totals.product.manufacturerids-{0}-{1}-{2}";
        public const string PRODUCT_MANUFACTURER_IDS_PATTERN_KEY = "DreamSale.totals.product.manufacturerids";
