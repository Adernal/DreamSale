...
using DreamSale.Core.Events;
using DreamSale.Infrastructure;
using DreamSale.Services.Events;

namespace DreamSale.Services.Discounts.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeleted<Manufacturer>>
    {
        ...
        /// {0} : discount id
        /// </remarks>
        public const string DISCOUNT_REQUIREMENT_MODEL_KEY = "DreamSale.discounts.requirements-{0}";
        public const string DISCOUNT_REQUIREMENT_PATTERN_KEY = "DreamSale.discounts.requirements";
        ...
        /// {2} : discount name
        /// </remarks>
        public const string DISCOUNT_ALL_KEY = "DreamSale.discounts.all-{0}-{1}-{2}";
        public const string DISCOUNT_ALL_PATTERN_KEY = "DreamSale.discounts.all";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string DISCOUNT_CATEGORY_IDS_MODEL_KEY = "DreamSale.discounts.categoryids-{0}-{1}-{2}";
        public const string DISCOUNT_CATEGORY_IDS_PATTERN_KEY = "DreamSale.discounts.categoryids";
        ...
        /// {2} : current store ID
        /// </remarks>
        public const string DISCOUNT_MANUFACTURER_IDS_MODEL_KEY = "DreamSale.discounts.manufacturerids-{0}-{1}-{2}";
        public const string DISCOUNT_MANUFACTURER_IDS_PATTERN_KEY = "DreamSale.discounts.manufacturerids";
