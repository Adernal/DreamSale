...
namespace DreamSale.Services.Topics
{
    ...
    public partial class TopicService : ITopicService
    {
        ...
        /// {2} : show hidden?
        /// </remarks>
        private const string TOPICS_ALL_KEY = "DreamSale.topics.all-{0}-{1}-{2}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : topic ID
        /// </remarks>
        private const string TOPICS_BY_ID_KEY = "DreamSale.topics.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string TOPICS_PATTERN_KEY = "DreamSale.topics.";
