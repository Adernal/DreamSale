...
namespace DreamSale.Services.Common
{
    ...
    public partial class AddressAttributeFormatter : IAddressAttributeFormatter
    {
        ...
        public AddressAttributeFormatter(IWorkContext workContext, IAddressAttributeService addressAttributeService, IAddressAttributeParser addressAttributeParser)
        {
