...
namespace DreamSale.Services.Forums
{
    ...
    public partial class ForumService : IForumService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string FORUMGROUP_ALL_KEY = "DreamSale.forumgroup.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : forum group ID
        /// </remarks>
        private const string FORUM_ALLBYFORUMGROUPID_KEY = "DreamSale.forum.allbyforumgroupid-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string FORUMGROUP_PATTERN_KEY = "DreamSale.forumgroup.";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string FORUM_PATTERN_KEY = "DreamSale.forum.";
        ...
        public virtual void InsertPrivateMessage(PrivateMessage privateMessage)
        {
            ...
            if (customerTo == null)
            {
                throw new DreamSaleException("Recipient could not be loaded");
            }
