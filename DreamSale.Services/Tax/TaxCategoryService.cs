...
namespace DreamSale.Services.Tax
{
    /// <summary>
    ...
    public partial class TaxCategoryService : ITaxCategoryService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string TAXCATEGORIES_ALL_KEY = "DreamSale.taxcategory.all";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        /// {0} : tax category ID
        /// </remarks>
        private const string TAXCATEGORIES_BY_ID_KEY = "DreamSale.taxcategory.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string TAXCATEGORIES_PATTERN_KEY = "DreamSale.taxcategory.";
        ...
        public TaxCategoryService(ICacheManager cacheManager, IRepository<TaxCategory> taxCategoryRepository//,EventPublisher eventPublisher
            )
        {
