...
namespace DreamSale.Services.Shipping
{
    ...
    public partial class ShippingService : IShippingService
    {
        ...
        /// {0} : warehouse ID
        /// </remarks>
        private const string WAREHOUSES_BY_ID_KEY = "DreamSale.warehouse.id-{0}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string WAREHOUSES_PATTERN_KEY = "DreamSale.warehouse.";
            ...
            int storeId = 0)
        {
            ...
            if (!shippingRateComputationMethods.Any())
                //throw new DreamSaleException("Shipping rate computation method could not be loaded");
                return result;
