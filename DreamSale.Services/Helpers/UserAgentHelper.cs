...
namespace DreamSale.Services.Helpers
{
    /// <summary>
    /// User agent helper
    /// </summary>
    ...
    {
        private readonly DreamSaleConfig _config;
        ...
        public UserAgentHelper(DreamSaleConfig config, HttpContextBase httpContext)
        {
            this._config = config;
        ...
        public virtual bool IsSearchEngine()
        {
            ...
            //more info: http://www.DreamSale.com/boards/t/17711/unhandled-exception-request-is-not-available-in-this-context.aspx
            try
            {
