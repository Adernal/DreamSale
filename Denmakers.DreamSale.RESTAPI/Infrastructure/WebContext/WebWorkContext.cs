...
using Denmakers.DreamSale.Services.Authentication;
...
namespace Denmakers.DreamSale.RESTAPI.Infrastructure.WebContext
{
    public partial class WebWorkContext : IWorkContext
    {
        ...
        private const string CustomerCookieName = "DreamSale.customer";
        ...
        public virtual Customer CurrentCustomer
        {
            get
            {
                ...
                if (customer != null && !customer.Deleted && customer.Active && !customer.RequireReLogin)
                {
                    var impersonatedCustomerId = customer.GetAttribute<int?>(SystemCustomerAttributeNames.ImpersonatedCustomerId, _genericAttributeService);
