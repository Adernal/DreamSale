...
using DreamSale.Data.Initializers;
using System;
...
namespace DreamSale.Data.DataProvider
{
    public class SqlServerDataProvider : IDataProvider
    {
        ...
        {
            //pass some table names to ensure that we have DreamSale 2.X installed
            ...
            var initializer = new CreateTablesIfNotExist<DreamSaleObjectContext>(tablesToValidate, customCommands.ToArray());
